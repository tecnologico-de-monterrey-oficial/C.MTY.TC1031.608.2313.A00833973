...
template <class T>
void createRandomList(DoublyLinkedList<T>& list, int quantity)
{
...
void menu(int& option ){
    ...
    while (option < 0 || option>18){
        ...
        cout << "14. Clear" <<endl;
        cout << "15. Sort" <<endl;
        cout << "16. Duplicate elements" <<endl;
        cout << "17. Remove duplicates" <<endl;
        cout << "18. Exit"<<endl;
        cin >> option;
    }
}
...
/// @param option int
template <class T>
void manipulateList(DoublyLinkedList<T>& list, int& option){
    ...
    case 14: //Limpiar la lista
        list.clear();
        break;
    case 15: //Ordenar la lista
    {
        list.sort();
        list.print();
        break;
    }
    case 16: //Duplicar elementos
        {
        list.duplicate();
        list.print();
        break;
        }   
    case 17: //Remove duplicados
    {   
        list.sort();
